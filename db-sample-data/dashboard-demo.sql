...
CREATE TABLE public.trafficviolation_test (
...
COPY public.trafficviolation_test (violation_id, photo_id, location, longitude, latitude, violation_date, violation_time, device_id, speed_limit, vehicle_speed, license_plate, licensplatereplydate, licenseplatereplytime, owner_name, vehicletype, owner_address, vehiclestatuscode) FROM stdin;
